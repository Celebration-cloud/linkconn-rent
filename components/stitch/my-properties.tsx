  ...
  return (
    <main id="main-content" className="min-h-[100dvh] bg-sand-50 pb-24">
      <div className="stitch-container py-7">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between"><div className="flex items-start gap-3"><Link href="/" className="grid size-11 shrink-0 place-items-center rounded-lg hover:bg-sand-100" aria-label="LinkConn Rent home"><Logo variant="mark" priority className="size-9" sizes="36px" /></Link><div><h1 className="text-2xl font-extrabold">My properties</h1><p className="mt-1 text-sm text-muted">Manage listings, track revenue, and resolve property issues.</p></div></div><Link href="/dashboard/properties/new" className="stitch-button"><Plus className="h-4 w-4" /> Add new property</Link></div>
